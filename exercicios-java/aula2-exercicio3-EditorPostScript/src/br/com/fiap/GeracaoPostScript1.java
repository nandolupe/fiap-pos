...
public class GeracaoPostScript1
{
	...
	public static void main( String[ ] args )
	{
		...
		try
		{
			...
			String commandPDF2PS = "pdftops32.exe -paper A4" ;
//			String commandPDF2PS = "pdftops64.exe -paper A4" ;
			...
			PrintWriter printWriter = new PrintWriter( new BufferedWriter( new FileWriter( "6.ps",
					false ) ) ) ;
			while (( lineContent = bufferedReader.readLine( ) ) != null)
			{
				if (lineContent.equals( "%%PageTrailer" )
						&& ( ++counter == ( ( Integer ) pageNumberList.get( pdfCounter ) )
								.intValue( ) ))
				{
			...
			System.out
					.println( "Tempo total execução: " + ( System.currentTimeMillis( ) - tmpini ) ) ;
