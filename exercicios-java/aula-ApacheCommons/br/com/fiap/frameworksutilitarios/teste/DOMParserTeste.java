...
public class DOMParserTeste
{
	...
	public static void main( String[ ] args ) throws Exception
	{
		...
		for (int contador = 0; contador < document.getElementsByTagName( "autor" ).getLength( ); contador++)
		{
			...
			autor.setNome( document.getElementsByTagName( "autor" ).item( contador )
					.getFirstChild( ).getNodeValue( ) ) ;
			autor.setId( document.getElementsByTagName( "autor" ).item( contador ).getAttributes( )
					.item( 0 ).getNodeValue( ) ) ;
			autores.add( autor ) ;
		}
