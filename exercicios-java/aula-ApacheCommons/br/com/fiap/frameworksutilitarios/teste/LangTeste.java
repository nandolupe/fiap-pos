...
public class LangTeste
{
	...
	public static void main( String[ ] args ) throws Exception
	{
		...
		{ "Gol", "Corsa", "Montana", "Civic", "Sandero", "Polo" } ;
		ArrayUtils.indexOf( carros, "Corsa" ) ;
		System.out.println( "Procurando Civic: \nEncontrado na posição "
				+ ArrayUtils.indexOf( carros, "Civic" ) + " do array." ) ;
		System.out.println( "Carros: " + ArrayUtils.toString( carros ) ) ;

		// data
		System.out.println( "Data com arredondamento de hora: "
				+ DateUtils.round( new Date( ), Calendar.HOUR ) ) ;
		System.out.println( "Data com dia truncado: "
				+ DateUtils.truncate( new Date( ), Calendar.DAY_OF_MONTH ) ) ;

		// String Utils
		String string = "Teste do String Utils." ;

		System.out.println( "caracter \"e\" countMatches: "
				+ StringUtils.countMatches( string, "e" ) ) ;
