...
/**
 * Classe responsável em gerenciar as ações do cadastro de clientes
 * 
...
public class ClienteMB {
	...
	/**
	 * Como no JSF 1.2 não tem um tratamento adequado ao objeto {@link java.util.Date}
	...
	/**
	 * Lista em memória, que dará a impressão de um cadastro em uma base de dados.
	 */
	...
	/**
	 * Método responsável em inserir um cliente em nossa Lista.
	 * 
	 * @return
	 */
	public String inserirCliente() {
		...
		// CRIA UMA NOVA REFERENCIA EM MEMÓRIA PARA UM PRÓXIMO CADASTRO.
		cliente = new Cliente();
		dtNasc = null;
		return "success";
	}
	...
	/**
	 * Responsável em Remover um cliente da lista.
	 * 
	 * @return
	 */
