 ...
 *
 * Classe responsável em apresentar as telas com as funcionalidades de Mensagem.
 *
...
public class MensagemView {
	...
	/**
	 * Metodo telaInicial, executa a tela inicial da aplicação.
	 *
	 *
	 * @since 15/07/2014 - Luiz Fernando
	 */
	...
	/**
	 * Metodo telaCodificar, inicia a tela de codificação de mensagem.
	 *
	 *
	 * @since 15/07/2014 - Luiz Fernando
	 */
	...
	/**
	 * Metodo telaDecodificar, inicia a tela de decodificação de mensagem.
	 *
	 *
	 * @since 15/07/2014 - Luiz Fernando
	 */
