 ...
 *
 * Responsável em contemplar todas as funcionalidades comuns na aplicação
 * 
...
public class Util {
	...
	/*
	 * Map que contém as vogais convertidas em numerico.
	 */
	private static Map<Integer, Integer> vogaisNumericoMap = new HashMap<>();
	/*
	 * .
	 * Map que contém os numericos convertidos em vogais.
	 */
	private static Map<Integer, Integer> numericoVogaisMap = new HashMap<>();
	
	/*
	 * 
	 * Static responsável em inicializar os maps com os valores das vogais e numericos.
	 */
	static {
	...
	/**
	 * Método criptografar, responsável em criptografar uma mensagem.
	 * Regras:
	 * - Transforma as vogais em numéricos (a=1, e=2, i=3, o=4, u=5)
	 * - Transforma as consoantes convertendo seu código ASCII + 6
	 *
	 * @param texto
	 * @return
	 *
	...
	/**
	 * Metodo descriptografar, responsável em descriptografar uma mensagem.
	 * - Transforma os numéricos em vogais (1=a, 2=e, 3=i, 4=o, 5=u)
     * - Transforma as consoantes convertendo seu código ASCII - 6
     * 
	 * @param texto
	 * @return
	...
	/**
	 * Metodo converteInt, responsável em converter uma String em um int.
	 *
	 * @param msg
	 * @return
	 *
